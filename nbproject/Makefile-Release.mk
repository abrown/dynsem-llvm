...
${OBJECTDIR}/engine.o: engine.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine.o engine.c

${OBJECTDIR}/log.o: log.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log.o log.c
...
${OBJECTDIR}/types.o: types.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/types.o types.c
...
${OBJECTDIR}/engine_nomain.o: ${OBJECTDIR}/engine.o engine.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine_nomain.o engine.c;\
	else  \
...
${OBJECTDIR}/log_nomain.o: ${OBJECTDIR}/log.o log.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log_nomain.o log.c;\
	else  \
...
${OBJECTDIR}/types_nomain.o: ${OBJECTDIR}/types.o types.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -std=c11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/types_nomain.o types.c;\
	else  \
